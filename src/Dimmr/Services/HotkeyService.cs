...
public sealed class HotkeyService : IDisposable
{
    ...
    public void Register()
    {
        ...
        NativeMethods.RegisterHotKey(_hwnd, IdBrighter, NativeMethods.MOD_ALT | noRepeat, NativeMethods.VK_PRIOR);
        NativeMethods.RegisterHotKey(_hwnd, IdDimmer, NativeMethods.MOD_ALT | noRepeat, NativeMethods.VK_NEXT);
    }
